        ...
        <div>
            <section id="Home" className="home">
                <div className="home-content">
                    ...
                    <a href="https://drive.google.com/file/d/1JXOpNTQE5C8rdEtYtRasfN9fgsQKDDL8/view" style={{ '--i': 11 }} className="btn-box" target="_blank" rel="noopener noreferrer">Download Resume</a>
                </div>
            </section>
